// Store our API endpoint inside queryUrl - move to d3 line - line 10
// let queryUrl = "../datafile/HAR.geojson";
...
d3.json('/data').then( res => res.text())
...
//         // let geoData = "../datafile/elem_heatmap.geojson";
//         // let geoData = data

//         // Perform a GET request to the geoData URL  
//         // d3.json(data).then(schooldata => {
